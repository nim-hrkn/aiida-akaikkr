...
<li>2022.0721 の akaikkr ビルドは Hf を含む go が reconf で止まります。cpa2021v01 ビルドを使います。Hf の 4f は積分路の下端に張り付く性質があり、ewidth 0.9 付近しか収束しません。</li>
<li>混晶（CPA）の構造は pymatgen で扱います（ASE は部分占有を受け付けません）。</li>
