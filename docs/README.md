...
| 文書 | 内容 |
|---|---|
| [intro.html](intro.html) | 入門 | 初心者向けの説明、日本語 / 英語切替（構成図、来歴の例、KKR の ewidth と semicore、GAES の 2 例、レポート、LLM 経由の操作、動かすまで、付録に SmCo5 のレポート）。`data/intro/build_intro.py` で SVG から組み立てる |
